...
namespace AtlusLibSharp.Common.FileSystem.Archives
{
    ...
    public class ListArchiveFile : BinaryFileBase, IArchive
    {
        // Fields
        ...
        public ListArchiveFile(string path)
        {
            ...
            {
                throw new InvalidDataException("Not a valid ListArchive.");
            }
        ...
        public static ListArchiveFile Create(PAKToolFile pak)
        {
            ListArchiveFile arc = new ListArchiveFile();
            foreach (PAKToolFileEntry entry in pak.Entries)
            {
