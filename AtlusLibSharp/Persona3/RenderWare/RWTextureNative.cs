namespace AtlusLibSharp.Persona3.RenderWare
{
    ...
    public class RWTextureNative : RWNode, ITextureFile
    {
        ...
        /// <summary>
        /// Gets and sets the <see cref="PS2.Graphics.FilterMode"/> of this texture node.
        /// </summary>
        ...
        /// <summary>
        /// Gets and sets the horizontal <see cref="AddressingMode"/> of this texture node used to control texture wrapping.
        /// </summary>
        public AddressingMode HorrizontalAddressingMode
        {
        ...
        /// <summary>
        /// Gets and sets the vertical <see cref="AddressingMode"/> of this texture node used to control texture wrapping.
        /// </summary>
        ...
        public RWTextureNative(string path, PixelFormat pixelFormat) 
        ...
        /// <param name="pixelFormat">PS2 Pixel format to encode the bitmap to.</param>
        public RWTextureNative(string name, Bitmap bitmap, PixelFormat pixelFormat)
        ...
        /// <param name="pixelFormat">PS2 Pixel format to encode the bitmap to.</param>
        public RWTextureNative(string name, int width, int height, Color[] palette, byte[] indices, PixelFormat pixelFormat)
            : base(RWType.TextureNative)
        {
        ...
        /// </summary>
        internal RWTextureNative(RWNodeFactory.RWNodeProcHeader header, BinaryReader reader)
            : base(header)
        {
